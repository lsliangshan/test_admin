...
// Source: aside.js
  angular.module('mgcrea.ngStrap.aside', ['mgcrea.ngStrap.modal'])
    ...
    .directive('jAside', ["$window", "$sce", "$aside", function ($window, $sce, $aside) {
      ...
      return {
        ...
        link: function postLink(scope, element, attr, transclusion) {
          ...
          // Support scope as an object
          attr.jAside && scope.$watch(attr.jAside, function (newValue, oldValue) {
            if (angular.isObject(newValue)) {
              angular.extend(scope, newValue);
            } else {
              scope.content = newValue;
...
// Source: dropdown.js
  angular.module('mgcrea.ngStrap.dropdown', ['mgcrea.ngStrap.tooltip'])
    ...
    .directive('jDropdown', ["$window", "$sce", "$dropdown", function ($window, $sce, $dropdown) {
      ...
      return {
        ...
        link: function postLink(scope, element, attr, transclusion) {
          ...
          // Support scope as an object
          attr.jDropdown && scope.$watch(attr.jDropdown, function (newValue, oldValue) {
            scope.content = newValue;
          }, true);
...
// Source: modal.js
  angular.module('mgcrea.ngStrap.modal', ['mgcrea.ngStrap.helpers.dimensions'])
    ...
    .directive('jAlert', ["$window", "$sce", "$modal", function ($window, $sce, $modal) {
      ...
      return {
        ...
        link: function postLink(scope, element, attr, transclusion) {
          ...
          // Support scope as an object
          attr.jAlert && scope.$watch(attr.jAlert, function (newValue, oldValue) {
            if (angular.isObject(newValue)) {
              angular.extend(scope, newValue);
            } else {
              scope.content = newValue;
...
// Source: tooltip.js
  angular.module('mgcrea.ngStrap.tooltip', ['mgcrea.ngStrap.helpers.dimensions'])
    ...
    .directive('jTooltip', ["$window", "$location", "$sce", "$tooltip", "$$rAF", function ($window, $location, $sce, $tooltip, $$rAF) {
      ...
      return {
        ...
        link: function postLink(scope, element, attr, transclusion) {
          ...
          // Support scope as an object
          attr.jTooltip && scope.$watch(attr.jTooltip, function (newValue, oldValue) {
            if (angular.isObject(newValue)) {
              angular.extend(scope, newValue);
            } else {
